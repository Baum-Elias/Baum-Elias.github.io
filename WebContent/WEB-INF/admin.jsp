...
<ul class="layui-nav">
  	...
  	<li class="layui-nav-item" style="float:right;">
    	<a href="index.jsp"><img src="resources/images/admin.jpg" class="layui-nav-img">${username}</a>
	    <dl class="layui-nav-child">
	      <dd><a href="javascript:;" onclick="add()">发布新闻</a></dd>
	      <dd><a href="javascript:;" onclick="location.href = 'coreServlet?bizCode=9'">退了</a></dd>
	    </dl>
  	</li>
</ul>
