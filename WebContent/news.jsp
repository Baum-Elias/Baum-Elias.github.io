<%@page import="cn.nicecoder.pojo.News"%>
...
<body style="padding-bottom:50px;">
	...
	<div class="news" style="width:762px; margin:0 auto; margin-top:30px;">
		<h1>${news.title}</h1>
		<div style="font-size:14px; color:#666; line-height:12px; padding-top:30px; padding-bottom:30px;"><i class="layui-icon" style="font-size: 15px; color: #FF8C69;">&#xe60e;</i> ${myTag:formatDate(news.pudate)} &nbsp;&nbsp;${news.author} &nbsp;&nbsp;<span style="color: #20B2AA;"><a href="coreServlet?bizCode=7&type=${news.type_n}">${news.type}</a></span></div>
	...
	<div id="maodiv0" style="width:50px; height:100px; position:fixed; top:20px; right:10%; display:block;" >
...
<script>
	...
	function discuss(type, newsId, id){
		$("#dis-btn").attr("disabled","true");// 找到Id=dis-btn的标签
		var content = "";
		if(type == '0'){
	...
	$(window).scroll(function(){  
		if ($(window).scrollTop() >  $(window).height()-450 || $(window).scrollTop() == $(document).height() - $(window).height()) {
